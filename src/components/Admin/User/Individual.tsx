...
const roles = ['Buyer', 'Buyer', 'Seller'];
...
export default function Individual() {
  ...
  // Function to handle navigation to individual user detail page
  const handleViewIndividual = (userId: number) => {
    router.push(`/dashboard/user/individual/${userId}`);
  };
    ...
    <div className="min-h-screen ">
      <div className="p-4 sm:p-6 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-2">
          <MoveLeft />
          <button onClick={()=>window.history.back()} className="px-2 py-2 rounded-3xl font-medium">Individual Details</button>
        </div>
