  ...
  return (
    <div className="min-h-screen">
      <div className="p-4 sm:p-6 flex flex-col gap-6">
        ...
        <div>
          {isEditing ? (
            <div className="space-y-4 bg-white py-20 px-10">
              ...
              <div className="flex gap-2">
                <div
                  ...
                  className="px-4 py-2 w-full bg-[#FFE135] text-center mt-5  cursor-pointer  rounded"
                >
                  Update
                </div>
            ...
            <div className="space-y-4 bg-white py-20 px-10">
              ...
              <div
                className="prose prose-sm sm:prose md:prose-lg mb-20   dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-md"
                dangerouslySetInnerHTML={{ __html: content }}
              />
              
              <div 
                onClick={() => setIsEditing(true)}
                className="px-4 py-2 bg-[#FFE135] text-center    cursor-pointer  rounded"
              >
                Edit
              </div>
            </div>
