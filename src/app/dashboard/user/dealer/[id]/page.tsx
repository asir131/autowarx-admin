    ...
    <div className="min-h-screen ">
      ...
      <div className="w-[350px] md:w-[500px] lg:w-[800px] bg-white ml-6 mt-5 p-8 rounded-lg">
        <div className="lg:flex justify-between">
          <div>
            <p className="text-sm opacity-65 mb-5">Vendor Information</p>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full mt-5 justify-around">
            <div className=" text-center w-40 border borer-[#D2D2D2] rounded-md p-5 grid gap-5">
                    <h1>Total Product</h1>
            ...
            <div className=" text-center w-40 border borer-[#D2D2D2] rounded-md p-2 py-5  grid gap-5">
                    <h1>Completed Order</h1>
                    <p className="font-semibold text-2xl">3444</p>
            </div>
            <div className=" text-center w-40 border borer-[#D2D2D2] rounded-md p-5 grid gap-5">
